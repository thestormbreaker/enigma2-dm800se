...
class DeliteInaSetup(Screen, ConfigListScreen):
    ...
    def __init__(self, session, menu_path = ''):
        ...
        self['actions'] = ActionMap(['WizardActions', 'ColorActions'], {'green': self.saveIna,
         'back': self.close,
         'yellow': self.vkeyb})
        self.updateList()
...
class BhSpeedUp(Screen, ConfigListScreen):
    ...
    def __init__(self, session, firstrun = False, menu_path = ''):
        ...
        self['actions'] = ActionMap(['WizardActions', 'ColorActions'], {'red': self.close,
         ...
         'back': self.close})
        self.pluglist = [['DVDPlayer', 'enigma2-plugin-extensions-dvdplayer'], ['Dlna Browser (Djmount Client)', 'enigma2-plugin-extensions-dlnabrowser'], ['MiniDlna UPnP Server', 'enigma2-plugin-extensions-dlnaserver']]
